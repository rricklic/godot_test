...
@onready var start_game_button: Button = $MarginContainer/VBoxContainer/MarginContainer/ButtonContainer/StartGame
@onready var quit_game_button: Button = $MarginContainer/VBoxContainer/MarginContainer/ButtonContainer/QuitGame
